...
GFDL CM2.1海洋模式垂直方向上共50层，其水平分辨率在经度方向为1°，在纬度方向由极地地区的1°变化到赤道的1/3°。对于垂直方向，其最高22层中每层厚度为10米，共220米。其中，一个三极网格贯穿欧亚大陆、北美洲和南极洲，以避免北极上空出现极性滤波。该分辨率下可以比较明显地观测到ENSO事件的发生与否。图2.1为使用模式年数据（101~200），运行GFDL CM2.1模式生成的海表面温度（Sea Surface Temperature，简写为SST)模式值减去观测值的图像。
